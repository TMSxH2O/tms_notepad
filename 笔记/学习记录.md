...
+ BVH树 https://www.pbr-book.org/3ed-2018/Primitives_and_Intersection_Acceleration/Bounding_Volume_Hierarchies
...
3. <s>学习GAMES103 整理笔记，完整作业</s>（已完成 [[基于物理的计算机动画入门|跳转]]）<br>对物理动画部分的知识缺口较大，通过此教程补齐
